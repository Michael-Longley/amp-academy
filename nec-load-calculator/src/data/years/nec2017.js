// NEC 2017 Lookup Tables
// Source: Extracted from internal NEC load calculation spreadsheet
...
// Source: Tables!AG10:AJ108 in spreadsheet
// Columns: [qty, demandFactorOver12kW (AH), demandFactorCol3 (AI), demandKW_under12kW (AJ)]
// For nameplate ≤ 12 kW: demand = demandKW_under12kW × 1000 VA
// For nameplate > 12 kW: demand = nameplate × demandFactorOver12kW × qty (approx)
...
// Source: Tables!AC35:AE95 in spreadsheet
...
// Default appliance nameplate VA ratings (from spreadsheet cells C21-C50)
...
export const YEAR_NOTES = {
  optionalMethodNote: 'NEC 2017 § 220.82 — Optional calculation for dwelling units.',
  dryerNote: 'NEC 2017 § 220.54 — Minimum 5,000W per dryer.',
  rangeNote: 'NEC 2017 § 220.55 — Table 220.55 demand factors apply.',
  evNote: null,
};
